...
//		if (DEBUG) Log.v(TAG, "makeDefault:");
     ...
     * @param isRecordable
     */
    private final void init(final int maxClientVersion, Context sharedContext,
...
//        	if (DEBUG) Log.w(TAG, "swap:err=" + err);
    ...
    private final EGLContext createContext(final Context sharedContext, final EGLConfig config, final int version) {
