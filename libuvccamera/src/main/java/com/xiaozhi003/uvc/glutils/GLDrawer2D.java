...
import static com.xiaozhi003.uvc.glutils.ShaderConst.FRAGMENT_SHADER_SIMPLE;
import static com.xiaozhi003.uvc.glutils.ShaderConst.FRAGMENT_SHADER_SIMPLE_OES;
import static com.xiaozhi003.uvc.glutils.ShaderConst.GL_TEXTURE_2D;
import static com.xiaozhi003.uvc.glutils.ShaderConst.GL_TEXTURE_EXTERNAL_OES;
import static com.xiaozhi003.uvc.glutils.ShaderConst.VERTEX_SHADER;
...
//	private static final String TAG = "GLDrawer2D";
    ...
    public static final float[] VERTICES_0 = { // 原图
            1.0f, 1.0f, // rt
            -1.0f, 1.0f, // rb
            1.0f, -1.0f, // lt
            -1.0f, -1.0f // lb
    ...
    public static float VERTICES_0_MIRROR[] = {  //rotate 0 mirror
            1.0f, -1.0f,//rt
            -1.0f, -1.0f,//rb
            1.0f, 1.0f,//lt
            -1.0f, 1.0f,//lb
    ...
    public static float VERTICES_90[] = {  //rotate 90
            1.0f, -1.0f,//rt
            1.0f, 1.0f,//rb
            -1.0f, -1.0f,//lt
            -1.0f, 1.0f,//lb
    ...
    public static float VERTICES_90_MIRROR[] = {  //rotate 90 mirror
            -1.0f, -1.0f,//rt
            -1.0f, 1.0f,//rb
            1.0f, -1.0f,//lt
            1.0f, 1.0f,//lb
    ...
    public static float VERTICES_180[] = {  //rotate 180
            -1.0f, -1.0f,//rt
            1.0f, -1.0f,//rb
            -1.0f, 1.0f,//lt
            1.0f, 1.0f,//lb
    ...
    public static float VERTICES_180_MIRROR[] = {  //rotate 180 mirror
            -1.0f, 1.0f,//rt
            1.0f, 1.0f,//rb
            -1.0f, -1.0f,//lt
            1.0f, -1.0f,//lb
    ...
    public static float VERTICES_270[] = {  //rotate 270
            -1.0f, 1.0f,//rt
            -1.0f, -1.0f,//rb
            1.0f, 1.0f,//lt
            1.0f, -1.0f,//lb
    ...
    public static float VERTICES_270_MIRROR[] = {  //rotate 270 mirror
            1.0f, 1.0f,//rt
            1.0f, -1.0f,//rb
            -1.0f, 1.0f,//lt
            -1.0f, -1.0f,//lb
    ...
    public GLDrawer2D(final boolean isOES) {
        this(VERTICES_0, TEXCOORD, isOES);
    }

    public GLDrawer2D(final boolean isOES, float[] vertices) {
