...
public class UVCCamera {
    ...
    public static final int PIXEL_FORMAT_I420 = 4;    // i420, yyyyyyyyuuvv
    public static final int PIXEL_FORMAT_NV12 = 5;    // nv12, yyyyyyyyvuvu
    public static final int PIXEL_FORMAT_NV21 = 6;    // nv21, yyyyyyyyuvuv
    //--------------------------------------------------------------------------------
    ...
    static {
        if (!isLoaded) {
            System.loadLibrary("ec-jpeg-turbo1500");
            System.loadLibrary("ec-usb100");
            System.loadLibrary("ec-uvc");
            System.loadLibrary("ec-UVCCamera");
            isLoaded = true;
        }
    }
...
//================================================================================
    ...
    public synchronized void open(final UsbControlBlock ctrlBlock) {
        int result = openWithError(ctrlBlock);
...
//**********************************************************************
     ...
     * @param ctrlBlock
     */
    public synchronized int openWithError(final UsbControlBlock ctrlBlock) {
        int result;
        try {
        ...
        if (mNativePtr != 0 && TextUtils.isEmpty(mDescriptions)) {
...
//            mNativePtr = 0;    // nativeDestroyを呼ぶのでここでクリアしちゃダメ
     ...
     * you can use SurfaceHolder came from SurfaceView/UVCGLSurfaceView
     *
     * @param holder
     */
     ...
     * @return
     */
    public synchronized int getPress() {
        if (mCtrlBlock != null) {
            return mCtrlBlock.getPress();
        }
        return -1;
    }

    public synchronized String getECX101FocalLength() {
        if (mCtrlBlock != null) {
            return mCtrlBlock.getECX101FocalLength();
        }
        return null;
    }


    public synchronized String getECX101SN() {
        if (mCtrlBlock != null) {
            return mCtrlBlock.getECX101SN();
        }
        return null;
    }
     ...
     * 获取TLV并解析
     */
    public synchronized void getTlv() {
        if (mCtrlBlock != null) {
            mCtrlBlock.getTlv();
        }
    }
     ...
     * @param value
     */
    public synchronized int WriteToASIC(short addr, byte value) {
        if (mCtrlBlock != null) {
            return mCtrlBlock.writeToASIC(addr, value);
        }
        return -1;
    }
     ...
     * @param addr
     */
    public synchronized byte ReadToASIC(short addr) {
        if (mCtrlBlock != null) {
            return mCtrlBlock.readToASIC(addr);
        }
        return 0;
    }
    ...
    public int getWhiteBalanceMin() {
        return mWhiteBlanceMin;
    }

    public void setWhiteBalanceMin(int whiteBlanceMin) {
        mWhiteBlanceMin = whiteBlanceMin;
    }

    public int getWhiteBalanceMax() {
        return mWhiteBlanceMax;
    }

    public void setWhiteBalanceMax(int whiteBlanceMax) {
        mWhiteBlanceMax = whiteBlanceMax;
    }

    public int getWhiteBalanceDef() {
        return mWhiteBlanceDef;
    }

    public void setWhiteBalanceDef(int whiteBlanceDef) {
        mWhiteBlanceDef = whiteBlanceDef;
    }

    public int getBacklightCompMin() {
        return mBacklightCompMin;
    }

    public void setBacklightCompMin(int backlightCompMin) {
        mBacklightCompMin = backlightCompMin;
    }

    public int getBacklightCompMax() {
        return mBacklightCompMax;
    }

    public void setBacklightCompMax(int backlightCompMax) {
        mBacklightCompMax = backlightCompMax;
    }

    public int getBacklightCompDef() {
        return mBacklightCompDef;
    }

    public void setBacklightCompDef(int backlightCompDef) {
        mBacklightCompDef = backlightCompDef;
    }
    ...
    public void setBrightnessDef(int brightnessDef) {
        mBrightnessDef = brightnessDef;
    }
    ...
    public void setContrastMin(int contrastMin) {
        mContrastMin = contrastMin;
    }
    ...
    public void setContrastMax(int contrastMax) {
        mContrastMax = contrastMax;
    }
    ...
    public void setContrastDef(int contrastDef) {
        mContrastDef = contrastDef;
    }
    ...
    public void setSharpnessMin(int sharpnessMin) {
        mSharpnessMin = sharpnessMin;
    }
    ...
    public void setSharpnessMax(int sharpnessMax) {
        mSharpnessMax = sharpnessMax;
    }
    ...
    public void setSharpnessDef(int sharpnessDef) {
        mSharpnessDef = sharpnessDef;
    }
    ...
    public void setGammaDef(int gammaDef) {
        mGammaDef = gammaDef;
    }
    ...
    public void setSaturationDef(int saturationDef) {
        mSaturationDef = saturationDef;
    }
    ...
    public void setHueDef(int hueDef) {
        mHueDef = hueDef;
    }
     ...
     * @return whiteBlance[%]
     */
    public synchronized int getWhiteBalance(final int whiteBlance_abs) {
        int result = 0;
        if (mNativePtr != 0) {
    ...
    public synchronized int getRealWhiteBalance() {
        if (mNativePtr != 0) {
            return nativeGetWhiteBlance(mNativePtr);
        }
        return 0;
    }
     ...
     * @param whiteBlance [%]
     */
    public synchronized void setWhiteBalance(final int whiteBlance) {
        if (mNativePtr != 0) {
            final float range = Math.abs(mWhiteBlanceMax - mWhiteBlanceMin);
            if (range > 0)
    ...
    public synchronized void setRealWhiteBalance(final int whiteBlance) {
        if (mNativePtr != 0) {
            if (whiteBlance > mWhiteBlanceMax) {
                nativeSetWhiteBlance(mNativePtr, mWhiteBlanceMax);
            } else if (whiteBlance < mWhiteBlanceMin) {
                nativeSetWhiteBlance(mNativePtr, mWhiteBlanceMin);
            } else {
                nativeSetWhiteBlance(mNativePtr, whiteBlance);
            }
        }
    }
     ...
     */
    public synchronized int getBacklightComp(final int backlight_abs) {
        int result = 0;
        if (mNativePtr != 0) {
    ...
    public synchronized int getRealBacklightComp() {
        if (mNativePtr != 0) {
    ...
    public synchronized void setBacklightComp(final int backlightComp) {
        if (mNativePtr != 0) {
            final float range = Math.abs(mBacklightCompMax - mBacklightCompMin);
            if (range > 0)
                nativeSetBrightness(mNativePtr, (int) (backlightComp / 100.f * range) + mBacklightCompMin);
        }
    }

    public synchronized void setRealBacklightComp(final int backlightComp) {
        if (mNativePtr != 0) {
            if (backlightComp > mBacklightCompMax) {
                nativeSetBacklightComp(mNativePtr, mBacklightCompMax);
            } else if (backlightComp < mBacklightCompMin) {
                nativeSetBacklightComp(mNativePtr, mBacklightCompMin);
            } else {
                nativeSetBacklightComp(mNativePtr, backlightComp);
            }
        }
    }
    ...
    public synchronized int getRealBrightness() {
        if (mNativePtr != 0) {
    ...
    public synchronized void setRealBrightness(final int brightness) {
        if (mNativePtr != 0) {
            if (brightness > mBrightnessMax) {
                nativeSetBrightness(mNativePtr, mBrightnessMax);
            } else if (brightness < mBrightnessMin) {
                nativeSetBrightness(mNativePtr, mBrightnessMin);
            } else {
    ...
    public synchronized int getRealContrast() {
        if (mNativePtr != 0) {
    ...
    public synchronized void setRealContrast(final int contrast) {
        if (mNativePtr != 0) {
            nativeUpdateContrastLimit(mNativePtr);
            if (contrast > mContrastMax) {
                nativeSetContrast(mNativePtr, mContrastMax);
            } else if (contrast < mContrastMin) {
                nativeSetContrast(mNativePtr, mContrastMin);
            } else {
    ...
    public synchronized int getRealSharpness() {
        if (mNativePtr != 0) {
    ...
    public synchronized void setRealSharpness(final int sharpness) {
        if (mNativePtr != 0) {
            if (sharpness > mSharpnessMax) {
                nativeSetSharpness(mNativePtr, mSharpnessMax);
            } else if (sharpness < mSharpnessMin) {
                nativeSetSharpness(mNativePtr, mSharpnessMin);
            } else {
    ...
    public synchronized int getRealGain() {
        if (mNativePtr != 0) {
    ...
    public synchronized void setRealGain(final int gain) {
        if (mNativePtr != 0) {
            if (gain > mGainMax) {
                nativeSetGain(mNativePtr, mGainMax);
            } else if (gain < mGainMin) {
                nativeSetGain(mNativePtr, mGainMin);
            } else {
    ...
    public synchronized int getRealGamma() {
        if (mNativePtr != 0) {
    ...
    public synchronized void setRealGamma(final int gamma) {
        if (mNativePtr != 0) {
            if (gamma > mGammaMax) {
                nativeSetGamma(mNativePtr, mGammaMax);
            } else if (gamma < mGammaMin) {
                nativeSetGamma(mNativePtr, mGammaMin);
            } else {
    ...
    public synchronized int getRealSaturation() {
        if (mNativePtr != 0) {
    ...
    public synchronized void setRealSaturation(final int saturation) {
        if (mNativePtr != 0) {
            if (saturation > mSaturationMax) {
                nativeSetSaturation(mNativePtr, mSaturationMax);
            } else if (saturation < mSaturationMin) {
                nativeSetSaturation(mNativePtr, mSaturationMin);
            } else {
    ...
    public synchronized int getRealHue() {
        if (mNativePtr != 0) {
    ...
    public synchronized void setRealHue(final int hue) {
        if (mNativePtr != 0) {
            if (hue > mHueMax) {
                nativeSetHue(mNativePtr, mHueMax);
            } else if (hue < mHueMin) {
                nativeSetHue(mNativePtr, mHueMin);
            } else {
