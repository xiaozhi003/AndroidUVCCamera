package com.xiaozhi003.uvc.demo.adapter;
...
public class PreviewSizeAdapter implements SpinnerAdapter {

    private Context mContext;
    private List<Size> mPreviewSizeList;
    private LayoutInflater mLayoutInflater;

    public PreviewSizeAdapter(Context context, List<Size> previewSizeList) {
        mContext = context;
